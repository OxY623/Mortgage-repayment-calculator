...
src/
app/ # точка входа, глобальные настройки
processes/ # бизнес-процессы (авторизация, онбординг)
pages/ # страницы (роуты)
widgets/ # крупные UI-блоки (header, sidebar)
features/ # функциональные фичи (лайк, фильтр, поиск)
entities/ # бизнес-сущности (User, Product, Article)
shared/ # переиспользуемые утилиты, UI, libs
